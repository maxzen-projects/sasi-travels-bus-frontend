  ...
  const legends = [
    {
      label: "Available",
      box: (
        <div className="w-8 h-8 border-2 border-green-500 rounded-full bg-white" />
      ),
    },
    {
      label: "Male",
      box: (
        <div className="w-8 h-8 border-2 border-blue-500 rounded-full flex items-center justify-center bg-white">
    ...
    // },
    {
      label: "Selected",
      box: (
        <div className="w-8 h-8 border-2 border-green-600 bg-green-100 rounded-full" />
      ),
    },
    {
      label: "Sold",
      box: (
        <div className="w-8 h-8 border-2 border-gray-300 rounded-full flex items-center justify-center bg-gray-300">
